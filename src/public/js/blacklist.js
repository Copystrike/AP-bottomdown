...
async function modelOpen(btn, { modelTitle, modelBody, modelFooter }) {
  ...
  <button type="button" onclick="deleteBlacklist('${character.id}')" class="btn btn-danger">Verwijderen</button>
  <button type="button" onclick="updateBlacklistReason('${fortniteCharacterId}')" class="btn btn-primary">Update Blacklist Reden</button>
